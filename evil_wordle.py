        ...
        if not isinstance(other, WordFamily):
            ...
            if len(self.words) > len(other.words):
                ...
                if self.difficulty > other.difficulty:
                    ...
                    temp_word = "aaaaa"
                    return color_word(self.feedback_colors, temp_word) < color_word(other.feedback_colors, temp_word)
        return False
...
def get_feedback(remaining_secret_words, guessed_word):
    ...
    for word in remaining_secret_words:
        ...
        if feedback_colors not in words_dict:
            words_dict[feedback_colors] = [word]
        else:
            words_dict[feedback_colors].append(word)

    family_list = []
    for key in words_dict:
        family_list.append(WordFamily(key, words_dict[key]))

    hard_list = fast_sort(family_list)
    return hard_list[0].feedback_colors, hard_list[0].words
